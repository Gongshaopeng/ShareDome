...
{
    if (isError == YES) {
        return  [SGQRCodeTool SG_generateWithLogoQRCodeData:[self decodeFromPercentEscapeString:url]?:@"" logoImageName:@"about_bird_1" logoScaleToSuperView:0.2];
    }else{
        NSString * strUrl = url;
...
//            }
        ...
        return [SGQRCodeTool SG_generateWithLogoQRCodeData:[self decodeFromPercentEscapeString:strUrl]?:@"" logoImageName:@"about_bird_1" logoScaleToSuperView:0.2];
    }
