...
#define NavigationBarHeight (kScreenHeight == 812.0 ? (88*2) : (64*2))
#define __TabBarH__ (kScreenHeight == 812.0 ?(108) :(88))
...
#define __kTopViewHeight__ (330-16)
#define __kTopNaviBtnHeight__ (300)
